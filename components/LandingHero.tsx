...
export default function LandingHero({ onGetStarted, onSkip }: LandingHeroProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center px-4 pt-[15vh] pb-[15vh] text-center">
      ...
      {/* Trust line */}
      <div className="mt-6 flex items-center gap-2 rounded-full border border-[#00e5a0]/20 bg-[#00e5a0]/5 px-4 py-2">
        <svg className="h-4 w-4 shrink-0 text-[#00e5a0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
        </svg>
        <span className="text-xs font-medium text-[#00e5a0]/90">API 키는 브라우저에만 저장되며 서버에 보관되지 않습니다</span>
      </div>
    </div>
  );
}
